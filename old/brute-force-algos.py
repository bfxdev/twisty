...
# Tries to find turn sequences that leave a certain number of pieces untouched
...
class Cube:
  ...
  def getDiffs(self):
    'Returns the differences compared to an untouched cube, as a dictionary LE, LC, ME, TE, TC'
  ...
  if num == 0:
    ...
    for f in ['L','R','T']: # ,'BL']: #, 'B', 'BR']:
      for d in ['E','A']:
        ...
        # Prepares sorting out the trivial move sequences
        ok = True
        l = len(ns)
